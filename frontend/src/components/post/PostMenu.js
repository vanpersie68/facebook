...
export default function PostMenu({postUserId, userId, imagesLength, setShowMenu, token, postId, 
checkSaved, setCheckSaved, images, postRef }){
    ...
    return(
        <ul className="post_menu" ref={menu}>
            ...
            {test && <MenuItem icon="turnOffNotifications_icon" title="Turn off notification for this post" />} 
